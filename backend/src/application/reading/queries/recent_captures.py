...
class RecentCaptureView:
    ...
    day: date
    more_in_book: int
    """Captures of this book on this day that the per-day cap left out.

    Non-zero only on the last capture the cap admitted, so a renderer prints
    "+N more" once per book per day without counting anything itself.
    """
