...
export type CreateBookmarkMutationVariables = { bookId: number; data: BookmarkCreateRequest };
...
export type DeleteBookmarkMutationVariables = { bookId: number; bookmarkId: number };
