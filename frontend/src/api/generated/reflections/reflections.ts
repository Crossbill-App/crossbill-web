...
export const getUpsertBookReflectionMutationKey = () => ['upsertBookReflection'] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    UpsertBookReflectionMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof upsertBookReflection>>,
  ...
  TContext
> => {
  const mutationKey = getUpsertBookReflectionMutationKey();
...
export type UpsertBookReflectionMutationVariables = {
  bookId: number;
  data: BookReflectionUpdateRequest;
};
