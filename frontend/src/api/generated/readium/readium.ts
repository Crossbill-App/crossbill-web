...
export const getStartPublicationSessionMutationKey = () => ['startPublicationSession'] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    StartPublicationSessionMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof startPublicationSession>>,
  ...
  TContext
> => {
  const mutationKey = getStartPublicationSessionMutationKey();
...
export type StartPublicationSessionMutationVariables = { bookId: number };
...
export const getPutReadingPositionMutationKey = () => ['putReadingPosition'] as const;
...
export const getPutReadingPositionMutationOptions = <TError = void, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    PutReadingPositionMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof putReadingPosition>>,
  ...
  TContext
> => {
  const mutationKey = getPutReadingPositionMutationKey();
  const { mutation: mutationOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export type PutReadingPositionMutationVariables = { bookId: number; data: ReadingPositionUpdate };
