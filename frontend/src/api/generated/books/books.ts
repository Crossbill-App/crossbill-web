...
export type UpdateBookMutationVariables = { bookId: number; data: BookUpdateRequest };
...
export const getUpdateReadingStageMutationKey = () => ['updateReadingStage'] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    UpdateReadingStageMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof updateReadingStage>>,
  ...
  TContext
> => {
  const mutationKey = getUpdateReadingStageMutationKey();
  const { mutation: mutationOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export type UpdateReadingStageMutationVariables = {
  bookId: number;
  data: BookReadingStageUpdateRequest;
};
