...
export const getBackfillEmbeddingsMutationKey = () => ['backfillEmbeddings'] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    BackfillEmbeddingsMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof backfillEmbeddings>>,
  ...
  TContext
> => {
  const mutationKey = getBackfillEmbeddingsMutationKey();
...
export type BackfillEmbeddingsMutationVariables = { params?: BackfillEmbeddingsParams };
