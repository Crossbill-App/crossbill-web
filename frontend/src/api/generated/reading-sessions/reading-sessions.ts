...
export const getUploadReadingSessionsMutationKey = () => ['uploadReadingSessions'] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    UploadReadingSessionsMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof uploadReadingSessions>>,
  ...
  TContext
> => {
  const mutationKey = getUploadReadingSessionsMutationKey();
...
export type UploadReadingSessionsMutationVariables = { data: ReadingSessionSyncRequest };
...
export const getSyncReadingSessionsMutationKey = () => ['syncReadingSessions'] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    SyncReadingSessionsMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof syncReadingSessions>>,
  ...
  TContext
> => {
  const mutationKey = getSyncReadingSessionsMutationKey();
  const { mutation: mutationOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export type SyncReadingSessionsMutationVariables = { data: ReadingSessionSyncRequest };
