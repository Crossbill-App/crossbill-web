...
export const getCreateFlashcardForBookMutationKey = () => ['createFlashcardForBook'] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    CreateFlashcardForBookMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof createFlashcardForBook>>,
  ...
  TContext
> => {
  const mutationKey = getCreateFlashcardForBookMutationKey();
...
export type CreateFlashcardForBookMutationVariables = {
  bookId: number;
  data: FlashcardCreateRequest;
};
...
export type DeleteFlashcardMutationVariables = { flashcardId: number };
...
export const getCreateFlashcardForHighlightMutationKey = () =>
  ['createFlashcardForHighlight'] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    CreateFlashcardForHighlightMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof createFlashcardForHighlight>>,
  ...
  TContext
> => {
  const mutationKey = getCreateFlashcardForHighlightMutationKey();
  const { mutation: mutationOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export type CreateFlashcardForHighlightMutationVariables = {
  highlightId: number;
  data: FlashcardCreateRequest;
};
...
export const getCreateFlashcardForNoteMutationKey = () => ['createFlashcardForNote'] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    CreateFlashcardForNoteMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof createFlashcardForNote>>,
  ...
  TContext
> => {
  const mutationKey = getCreateFlashcardForNoteMutationKey();
  const { mutation: mutationOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export type CreateFlashcardForNoteMutationVariables = {
  noteId: number;
  data: NoteFlashcardCreateRequest;
};
