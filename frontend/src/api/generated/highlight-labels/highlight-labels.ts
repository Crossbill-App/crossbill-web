...
export const getUpdateHighlightLabelMutationKey = () => ['updateHighlightLabel'] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    UpdateHighlightLabelMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof updateHighlightLabel>>,
  ...
  TContext
> => {
  const mutationKey = getUpdateHighlightLabelMutationKey();
...
export type UpdateHighlightLabelMutationVariables = { styleId: number; data: HighlightLabelUpdate };
...
export const getCreateGlobalHighlightLabelMutationKey = () =>
  ['createGlobalHighlightLabel'] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    CreateGlobalHighlightLabelMutationVariables,
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof createGlobalHighlightLabel>>,
  ...
  TContext
> => {
  const mutationKey = getCreateGlobalHighlightLabelMutationKey();
  const { mutation: mutationOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export type CreateGlobalHighlightLabelMutationVariables = { data: HighlightLabelCreate };
